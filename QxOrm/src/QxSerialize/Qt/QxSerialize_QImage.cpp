...
QX_BOOST_EXPORT_SERIALIZATION_FAST_COMPIL_CPP(QImage)

namespace boost {
namespace serialization {

template <class Archive>
inline void qx_save(Archive & ar, const QImage & t, const unsigned int file_version)
{
...
template <class Archive>
inline void qx_load(Archive & ar, QImage & t, const unsigned int file_version)
{
   Q_UNUSED(file_version);
   t = QImage();
   bool bIsNull(false);
